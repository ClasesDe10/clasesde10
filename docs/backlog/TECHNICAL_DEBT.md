...
| P1 | Apps Script legacy archivado | Copia historica + modulo matching aislado | Confusion operacional | Mantener en `legacy/apps-script` hasta decidir si se elimina |
