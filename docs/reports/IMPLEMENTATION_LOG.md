...
- Auditado `migration-private/sheets-2026-06-16/clasesde10-sheets-export.xlsx`; documentado en
...
- `legacy/apps-script/clasp-project/appsscript.json`: acceso cambiado a `MYSELF` para webapp y execution API.
