...
| Q26 | Vaciar clases/datos económicos y corregir el calendario y pagos de familias | en curso | CRM preservado; lógica desplegada en Hosting y `main` (`19869f4`) y verificada por HTTP: pago obligatorio completo por periodo con arrastre, marcado dada/no dada, solo dadas pagables, verde tras validación admin, bloqueo >30 días limitado a calendario/justificante y restauración automática tras validación. Worker crítico reducido de cada 10 minutos a una vez por hora y sin análisis costosos. La limpieza exacta con copia previa y verificación final está preparada y probada, pero Firestore aún rechaza el inventario por cuota diaria agotada. Acción siguiente: cuando se reponga la cuota, ejecutar y comprobar la limpieza a cero. |
...
- Acción siguiente: ejecutar la limpieza destructiva en cuanto Firestore reponga la cuota diaria, conservando copia previa y comprobación final a cero; después completar la comprobación autenticada de Q25-Q26.
