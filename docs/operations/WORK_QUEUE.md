...
| Q27 | Calendario admin con pagos exactos a profesores, deuda familiar visible y avisos claros | en curso | Cálculo local implementado: cada pago al profesor incluye todas las clases dadas y todavía impagadas hasta esa fecha, separa el periodo actual del arrastre y evita duplicar el total mensual. La deuda vencida se agrupa por familia y aparece en el día actual con importe y clases exactas; los días usan “Deben/Cobrar/Pagar X €”. Los avisos se agrupan por asunto, ocultan códigos internos y enlazan al calendario. Pruebas específicas, notificaciones, calendario y sintaxis verdes. Acción siguiente: batería integral, despliegue y comprobación visual/HTTP en producción. |

## Último punto de control

- Fecha: 2026-08-15.
- Completado: Q01-Q24 reconciliados, implementados, desplegados y verificados en producción; Q25-Q27 en curso.
...
- Acción siguiente: validar integralmente y publicar Q27; después comprobar el reintento de limpieza programado tras la reposición de cuota, la copia privada previa y el resultado productivo a cero, y completar la comprobación autenticada de Q25-Q26.
