...
| Q28 | Identidad completa, relación con el hijo y acceso a ficha en todo el panel admin | por verificar | Resolutor y componente compartidos aplicados a clases, calendario, pagos, finanzas, solicitudes, directorios CRM, selector de clase, documentos, incidencias, operaciones, centro de control, búsqueda global, chat y avisos. Resuelve alias UID→ficha, evita mostrar correo/ID como nombre, indica hijo/alumno/familia y ofrece “Ver ficha”. Batería integral verde y render local desktop/móvil sin desbordes; falta desplegar y repetir la comprobación contra los recursos servidos por producción. |

## Último punto de control

- Fecha: 2026-08-15.
- Completado: Q01-Q24 y Q27 reconciliados, implementados, desplegados y verificados en producción; Q25-Q26 en curso.
