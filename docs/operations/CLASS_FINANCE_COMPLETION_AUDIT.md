...
- La aceptación autenticada posterior está aislada en `ClasesDe10-PostResetAcceptance-20260816`: solo arranca después de los dos marcadores limpios, recupera antes de cada reintento cualquier cuenta, documento o justificante temporal que hubiera quedado huérfano, acredita de nuevo el cero y la integridad CRM, crea tres cuentas y datos temporales identificables, prueba CRM, vencimiento quincenal, marcado, deuda 25 + 35, rechazo parcial/manipulado, justificante real, bloqueo, cobro familiar 60, aviso vencido 25 y pago al profesor 40 en el calendario admin con todas las identidades, aprobación atómica, desbloqueo en vivo y verde en calendario; su `finally` elimina cuentas/documentos/binarios y vuelve a ejecutar el verificador independiente. El script está fijado por SHA-256 `0B233393F141109A24D74BAF6ACC557C97B78CF1565DFEA0C28890B89447FE63` y reintenta desde las 09:35 CEST.
- La tarea privada `ClasesDe10-WorkflowCleanup-20260816` no consulta Firebase: fija el finalizador por SHA-256 `2426EB9C66857FF705173432F6FE14DC1D36F6CFF8218B0162BDA63F4BD848D3`, exige los cuatro marcadores completos y enlazados a la misma ejecución, las huellas exactas, las copias locales, comparaciones CRM presentes y sin diferencias, todas las aserciones de aceptación —incluidos los importes del calendario admin—, cero cuentas temporales y Codex actualizado. Solo entonces conserva un marcador final y elimina todas las tareas temporales, incluida ella misma.
