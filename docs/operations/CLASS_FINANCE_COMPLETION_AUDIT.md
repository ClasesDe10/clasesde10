...
| Eliminar justificantes y binarios asociados | pendiente de producción | Detección de documentos, blobs, chunks, URLs históricas, adjuntos de chat y rutas de Storage; cada copia binaria exige tamaño, MD5 disponible y SHA-256 local antes del borrado | Cero documentos de pago, cero rutas `pagos/`, cero rutas explícitas y copia privada íntegra recalculada por el verificador independiente |
...
- La tarea `ClasesDe10-ClassFinanceVerify-20260816` espera el marcador del reset sin consumir lecturas, fija el verificador por SHA-256 `8740062C6C41026098607DC463FF526FFB827BDB9D77964481FE12A9CD05C9D2` y reintenta los días 16, 17 y 18 a las 09:15 CEST cada 10 minutos durante cuatro horas.
- La aceptación autenticada posterior está aislada en `ClasesDe10-PostResetAcceptance-20260816`: solo arranca después de los dos marcadores limpios, recupera antes de cada reintento cualquier cuenta, documento o justificante temporal que hubiera quedado huérfano, acredita de nuevo el cero y la integridad CRM, crea tres cuentas y datos temporales identificables, prueba CRM, el bloqueo del profesor a solo calendario tras cinco días y su desbloqueo al marcar, la espera obligatoria de la familia hasta esa marca, vencimiento quincenal, marcado, deuda 25 + 35, rechazo parcial/manipulado, justificante real, bloqueo familiar, cobro familiar 60, aviso vencido único y agrupado de 25 con familia, hijo y profesor identificados y accesos a sus perfiles, retirada del aviso tras aprobar, y pago al profesor 40 en el calendario admin con todas las identidades, aprobación atómica, desbloqueo en vivo y verde en calendario; su `finally` elimina cuentas/documentos/binarios y vuelve a ejecutar el verificador independiente. El script está fijado por SHA-256 `8950FC11F4D3012FEF5F0D1F0F9CEB706719CCA2C94029CC08DC81FFF00ED9BA` y reintenta desde las 09:35 CEST.
- La tarea privada `ClasesDe10-WorkflowCleanup-20260816` no consulta Firebase: fija el finalizador por SHA-256 `0D3A6F0A14DF169A2943E6CE5B420865127774BAEF5731ED421B88E7C0B26A53`, exige los cuatro marcadores completos y enlazados a la misma ejecución, las huellas exactas, las copias locales, comparaciones CRM presentes y sin diferencias, todas las aserciones de aceptación —incluidos el bloqueo/desbloqueo del profesor, el orden profesor-familia, los importes del calendario admin y el aviso de deuda claro, agrupado, plenamente identificado y resuelto tras la aprobación—, cero cuentas temporales y Codex actualizado. Solo entonces elimina y confirma la retirada de todas las tareas temporales, incluida ella misma, y después conserva el marcador final; cualquier fallo borra una evidencia previa para que nunca quede un éxito falso.
