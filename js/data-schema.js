...
export const CANONICAL_FIELDS = Object.freeze({
  ...
  profesores: [
    ...
    'schoolName', 'studyCenter', 'bachilleratoGrade', 'universityAverageGrade', 'availabilitySummary',
...
const COLLECTION_FIELD_ALIASES = Object.freeze({
  ...
  profesores: {
    ...
    schoolName: ['colegio', 'school', 'colegio_nombre'],
    studyCenter: ['centro_estudios', 'study_center', 'colegio_estudios', 'universidad', 'universityName'],
