...
(function () {
  ...
  // Firebase publica rutas limpias. Mantenerlas también en la navegación
  ...
  // ── NAV HTML ──────────────────────────────────────────────────────
  const navHTML = `
<nav id="mainNav" style="position:fixed;top:0;left:0;right:0;z-index:100;display:flex;align-items:center;justify-content:space-between;padding:0 5vw;height:70px;background:#0f1f3d;border-bottom:1px solid rgba(255,255,255,0.07)">
  <a href="${r('index.html')}" class="nav-logo" style="display:flex;align-items:center;gap:10px;text-decoration:none">
    <img src="/assets/img/logo-192.png" width="44" height="44"
         alt="ClasesDe10" style="height:44px;width:44px;border-radius:2px;object-fit:cover">
...
<footer style="background:#0f1f3d;color:rgba(255,255,255,.7);padding:52px 5vw 0;overflow-wrap:anywhere">
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(min(240px,100%),1fr));gap:40px;max-width:1100px;margin:0 auto;padding-bottom:40px">
    <div>
      <div style="display:flex;align-items:center;gap:10px;margin-bottom:16px">
        <img src="/assets/img/logo-192.png" width="40" height="40"
             style="width:40px;height:40px;border-radius:2px;object-fit:cover" alt="ClasesDe10">
    ...
    <div>
      <h3 style="color:#fff;font-weight:700;margin-bottom:16px;font-size:.9rem;text-transform:uppercase;letter-spacing:.06em">Contacto</h3>
      <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:10px">
  ...
  <div style="border-top:1px solid rgba(255,255,255,.1);padding:20px 0;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:10px;max-width:1100px;margin:0 auto">
    ...
    <span style="font-size:.78rem;color:rgba(255,255,255,.4)">Creado en Madrid</span>
  </div>
</footer>`;
