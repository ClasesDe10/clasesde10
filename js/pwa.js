  ...
  function rolePlaybookActions(role = dashboardRole()) {
    ...
    const byRole = {
      ...
      profesor: [
        ...
        { id: 'profesor:documents', label: 'Subir documentos', hint: 'DNI, notas y curriculum opcional', category: 'Confianza', section: 'documentos', selector: '#btn-subir-doc', priority: 7, keywords: 'dni notas expediente curriculum documentos verificacion' },
