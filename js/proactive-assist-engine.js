...
function buildAvailabilitySignals(dataset, options, nowMs, push) {
  ...
  for (const assignment of dataset.asignaciones || []) {
    ...
    push(proactiveSignal({
      ...
      expectedOutcome: 'Ambas partes proponen horarios compatibles con su disponibilidad real.',
      recommendedAction: 'Completar disponibilidad y cerrar el horario desde Mis profesores o Mis alumnos.',
