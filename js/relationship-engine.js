...
function actionForStage(stage, role, relationship) {
  ...
  const family = {
    ...
    profesor_asignado: buildAction('open_chat_family', 'familia', 'Abrir chat', 'Preséntate y acuerda el primer horario.', 'chat', 'high'),
    chat_pendiente: buildAction('contact_admin_chat', 'familia', 'Chat pendiente', 'El equipo debe activar el canal.', 'chat', 'normal'),
    pendiente_horario: buildAction('propose_schedule_family', 'familia', 'Proponer horario', 'Propón una fecha desde el chat.', 'chat', 'high'),
    horario_propuesto: buildAction('answer_schedule_family', 'familia', 'Responder horario', 'Acepta o rechaza la propuesta desde el chat.', 'chat', 'high'),
    ...
    pago_pendiente: buildAction('pay_family', 'familia', 'Revisar pago', 'Hay un pago pendiente asociado.', 'pagos', 'high'),
    pago_vencido: buildAction('pay_overdue_family', 'familia', 'Pago vencido', 'Regulariza el pago pendiente.', 'pagos', 'critical'),
  ...
  const teacher = {
    ...
    profesor_asignado: buildAction('open_chat_teacher', 'profesor', 'Abrir chat', 'Preséntate y acuerda el primer horario.', 'chat', 'high'),
    ...
    pendiente_horario: buildAction('propose_schedule_teacher', 'profesor', 'Proponer horario', 'Propón una fecha desde el chat.', 'chat', 'high'),
    horario_propuesto: buildAction('answer_schedule_teacher', 'profesor', 'Responder horario', 'Acepta o rechaza la propuesta desde el chat.', 'chat', 'high'),
