...
const EVENT_CATALOG = Object.freeze([
  ...
  { type: 'schedule.proposed', entityType: 'chats.programaciones', description: 'Horario de clase propuesto desde el chat.' },
  { type: 'schedule.accepted', entityType: 'chats.programaciones', description: 'Horario aceptado y listo para crear clase.' },
  { type: 'schedule.rejected', entityType: 'chats.programaciones', description: 'Horario rechazado por una de las partes.' },
  { type: 'document.created', entityType: 'documentos', description: 'Documento subido.' },
  { type: 'document.verified', entityType: 'documentos', description: 'Documento validado por administracion.' },
  { type: 'document.rejected', entityType: 'documentos', description: 'Documento rechazado o requiere correccion.' },
  ...
  { type: 'incident.resolved', entityType: 'incidencias', description: 'Incidencia cerrada o resuelta.' },
