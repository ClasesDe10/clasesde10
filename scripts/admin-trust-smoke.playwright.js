async (page) => {
  ...
  const result = {
    ...
    familyModalHasTrust: familyDetailButtons ? familyModalText.includes('Confianza familiar') : true,
    familyModalExplainsTrust: familyDetailButtons ? familyModalText.includes('Como se valora la relacion familiar') : true,
