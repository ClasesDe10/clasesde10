...
for (const needle of [
  ...
  'proactiveAssist',
  'lowSupplyRequestHours',
  'upcomingClassReadinessHours',
  'requestAvailabilityNudgeHours',
  'teacherPayoutReadinessHours',
  'verifiedTeacherIdleDays',
  'internalAssistantEnabled',
  'internalAssistantLongChatMessages',
  'internalAssistantConflictKeywordThreshold',
  'internalAssistantAutoCreateTasks',
  'teacherScanLimit',
  'maintenanceMode',
  'featureFlags',
]) {
