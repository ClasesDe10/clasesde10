...
const workerCompleteAccessContext = worker.slice(worker.indexOf('async function loadCompleteFamilyPaymentAccessContext'), worker.indexOf('async function loadCompleteTeacherAttendanceAccessContext'));
